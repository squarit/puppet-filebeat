...
class filebeat::repo {
  if $::filebeat::use_opensource == true {
    $debian_repo_url = "https://artifacts.elastic.co/packages/oss-${filebeat::major_version}.x/apt"
    $yum_repo_url = "https://artifacts.elastic.co/packages/oss-${filebeat::major_version}.x/yum"
  } else {
